...
export default function About() {
  return (
    <div className="bg-[#f8fafc] font-sans pb-20">
      ...
      <section className="relative w-full py-32 bg-[#0f172a] overflow-hidden border-b-8 border-orange-600">
        <div className="absolute inset-0 opacity-20">
          <img src="https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&q=80&w=1920" alt="PCB Tech Background" className="w-full h-full object-cover" />
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center md:text-left">
          <div className="inline-flex items-center justify-center md:justify-start gap-2 text-orange-400 font-bold text-xs tracking-[0.2em] uppercase border border-orange-500/30 bg-orange-500/10 px-4 py-2 rounded mb-6 shadow-sm">
            <Cpu size={16} /> ISO 9001:2015 Certified Supply Chain
          </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { icon: <Globe size={24} />, title: "Vast Product Range", desc: "Discover active and passive components, dev boards, and HMI displays across 15+ industrial categories." },
              { icon: <ShieldCheck size={24} />, title: "Quality Assurance", desc: "100% genuine silicon. Components undergo visual and bench testing before being dispatched." },
              { icon: <BarChart size={24} />, title: "Competitive Pricing", desc: "Direct manufacturer relationships allow us to provide aggressive BOM (Bill of Materials) volume pricing." },
              { icon: <Truck size={24} />, title: "Logistics & Delivery", desc: "Hassle-free ordering with premium nationwide couriers. 2 PM SLA for same-day dispatch." },
              { icon: <Building2 size={24} />, title: "B2B & Institutional", desc: "Dedicated support for University POs, GST invoicing, and strict net-term enterprise purchasing." },
              { icon: <Microscope size={24} />, title: "Tech-Driven UX", desc: "Our platform leverages AI concepts to ensure seamless browsing, secure transactions, and smart inventory mapping." }
            ].map((srv, idx) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            <div className="bg-white border-2 border-gray-200 p-10 lg:p-14 rounded shadow-sm relative overflow-hidden">
              <Target size={120} className="absolute -top-10 -right-10 text-gray-50 pointer-events-none" />
            ...
            <div className="bg-[#1e293b] border-2 border-[#1e293b] p-10 lg:p-14 rounded shadow-lg relative overflow-hidden">
              <Eye size={120} className="absolute -top-10 -right-10 text-gray-800 opacity-50 pointer-events-none" />
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
        <div className="max-w-3xl mx-auto">
          <CheckCircle2 size={48} className="text-orange-500 mx-auto mb-8" strokeWidth={2.5} />
